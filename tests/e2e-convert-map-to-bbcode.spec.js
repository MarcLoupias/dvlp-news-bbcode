...
describe('command :: "md-file-converter convert \'../../../dist\' \'tests/actual-files/news/test-news.md\'"', function () {
    ...
    it('should output a final bbcode file with a content equal to tests/expected-files/news/test-news.bbcode content', async () => {
        const results = await Promise.all([
            fsp.readFile('tests/actual-files/news/test-news.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/news/test-news.bbcode', { encoding: 'utf-8' })
        ]);
...
describe('command :: "md-file-converter convert \'../../../dist\' \'tests/actual-files/faq/**/*.md\'"', function () {
    ...
    it('should output qa and summary files in bbcode format with a content equal to the files located in tests/expected/faq/', async () => {
        const results = await Promise.all([
            fsp.readFile('tests/actual-files/faq/SUMMARY.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/SUMMARY.bbcode', { encoding: 'utf-8' }),

            fsp.readFile('tests/actual-files/faq/section-001/001.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-001/001.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-001/001.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-001/001.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-001/001.q003.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-001/001.q003.bbcode', { encoding: 'utf-8' }),

            fsp.readFile('tests/actual-files/faq/section-002/002.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-002/002.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-002/002.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-002/002.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-002/002.q003.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-002/002.q003.bbcode', { encoding: 'utf-8' }),

            fsp.readFile('tests/actual-files/faq/section-003/003.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-003/003.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-003/003.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-003/003.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-003/003.q003.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-003/003.q003.bbcode', { encoding: 'utf-8' }),

            fsp.readFile('tests/actual-files/faq/section-004/004.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-004/004.q001.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-004/004.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-004/004.q002.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/actual-files/faq/section-004/004.q003.bbcode', { encoding: 'utf-8' }),
            fsp.readFile('tests/expected-files/faq/section-004/004.q003.bbcode', { encoding: 'utf-8' })
        ]);
        expect(results[0]).to.equal(results[1]);
